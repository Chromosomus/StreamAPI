...
public class App {
    ...
    public static void main(String[] args) {
        ...
        User user3 = new User("Bobby Lee", true, new ArrayList<>(List.of("dadafdsfas", "dsdhfgs", "dfsdgdfga")), new ArrayList<>(List.of("dsafsdfdf", "dsfdfdfad")), 103200, LocalDateTime.of(198,12,31,4,20,2));
        users.add(user2);
        users.add(user3);
